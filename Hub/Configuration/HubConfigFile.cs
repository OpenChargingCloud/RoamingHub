...
namespace cloud.charging.open.RoamingHub.Configuration
{
    ...
    /// <summary>
    /// The configuration of this Hub, in a file beside it.
    /// </summary>
    /// <remarks>
    /// What a Hub is - what it is called in OCPI, where it
    ...
    /// </remarks>
    public sealed class HubConfigFile
    {
        ...
        /// </summary>
        public HubConfigFile(String Path)
        {
        ...
        /// </summary>
        public Boolean TryLoad([NotNullWhen(true)] out HubConfiguration?  Configuration,
                                                   out String?                Error)
        {
            ...
            if (!HubConfiguration.TryParse(document, out Configuration, out var problem))
            {
                Error = $"'{Path}': {problem}";
                return false;
            }
        ...
        /// </summary>
        /// <remarks>
        /// This is what makes a partial save safe: a Hub that only
                                       ...
                                       [NotNullWhen(false)] out String?   Error)
        {
            ...
            if (!File.Exists(Path))
            {
                // No file is not a failure, it is a Hub nobody has
        ...
        /// rather than half of the new one. A Hub that cannot read
                                ...
                                [NotNullWhen(false)] out String?  Error)
        {
            ...
            try
            {
                ...
                // Move, not copy: on every file system this Hub runs on
