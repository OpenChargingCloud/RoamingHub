...
namespace cloud.charging.open.RoamingHub
{
    ...
    /// </remarks>
    public partial class HubHTTPAPI
    {
        ...
        private Task<HTTPResponse> GetOCPIConfiguration(HTTPRequest Request)
        {
            ...
            return Task.FromResult(
                       JSONResponse(Request, HTTPStatusCode.OK, Hub.OCPIConfigurationJSON())
                   );
        ...
        private Task<HTTPResponse> GetPartners(HTTPRequest Request)
        {
            ...
            return Task.FromResult(
                       JSONResponse(Request, HTTPStatusCode.OK, Hub.RemotePartiesJSON(IncludeSecrets: mayManage))
                   );
        ...
        private async Task<HTTPResponse> PostPartner(HTTPRequest Request)
        {
            ...
            var result = await Hub.AddRemotePartyAsync(json);
            ...
            var response = new JObject(
                               ...
                               new JProperty("partners",  Hub.RemotePartiesJSON(IncludeSecrets: true))
                           );
        ...
        private async Task<HTTPResponse> PostPartnerRegister(HTTPRequest Request)
        {
            ...
            var result = await Hub.RegisterRemotePartyAsync(version, id);
        ...
        private async Task<HTTPResponse> DeletePartner(HTTPRequest Request)
        {
            ...
            var result = await Hub.RemoveRemotePartyAsync(version, id);
            ...
            return JSONResponse(Request, HTTPStatusCode.OK, Hub.RemotePartiesJSON(IncludeSecrets: true));
