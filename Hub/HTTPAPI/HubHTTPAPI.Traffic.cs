...
namespace cloud.charging.open.RoamingHub
{
    ...
    public partial class HubHTTPAPI
    {
        ...
        private void RegisterTrafficRoutes()
        {
            ...
            Hub.Traffic.OnCall += call => Publish(TrafficEvents, CallEventName, call.ToJSON());
        ...
        private Task<HTTPResponse> GetTraffic(HTTPRequest Request)
        {
            ...
            var calls  = Hub.Traffic.Recent(limit, after, peer).ToArray();
            ...
            return Task.FromResult(
                       JSONResponse(
                           ...
                           new JObject(
                               ...
                               new JProperty("lastId",    Hub.Traffic.LastId),
                               new JProperty("count",     Hub.Traffic.Count),
                               new JProperty("capacity",  Hub.Traffic.Capacity),
                               new JProperty("payloads",  Hub.OCPI.Logging?.Payloads == true),
                               new JProperty("peers",     new JArray(Hub.Traffic.KnownParties))
                           )
                       )
                   );
        ...
        /// reasons - see StreamEvents in HubHTTPAPI.cs, which this follows
