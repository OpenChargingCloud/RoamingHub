    ...
    public partial class Hub
    {
        ...
        public JObject DNSConfigurationJSON()
            ...
            => new (
                   ...
                   // The servers this Hub would ask, which is not the same
        ...
        /// <summary>
        /// Change how this Hub resolves names, at once and for everything
                                                 ...
                                                 [NotNullWhen(false)] out String?  Error)
        {
            ...
            {
                Error = "A Hub that resolves no names cannot reach its time server, nor anything else it is pointed at by name. Switch name resolution off instead of emptying the list.";
                return false;
            }

            // Under the same lock as every other change to this Hub:
        ...
        private void ApplyDNSConfiguration(DNSConfiguration Configuration)
        {
            ...
            // must end up holding exactly the servers this Hub means it to
        ...
        /// <summary>
        /// Where this Hub gets the time from, and how the key exchange
        /// behind it is doing.
        /// </summary>
        ...
        /// <summary>
        /// Change where this Hub reads the time.
        /// </summary>
        /// <remarks>
        /// Pointing the Hub at another server replaces the client rather
        ...
        private void ApplyNTSConfiguration(NTSConfiguration Configuration)
        {
                ...
                ntp      != ntsClient.NTP_Port)
            {
                ...
                // about the last exchange belongs to a server this Hub no
                // longer asks.
                lastTimeSync = null;
