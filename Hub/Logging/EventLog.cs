...
namespace cloud.charging.open.RoamingHub.Logging
{
    ...
    /// <summary>
    /// Everything that happens inside this Hub, in one place: the
    ...
    /// actually has in front of a Hub is "what happened just now",
    ...
    public sealed class EventLog
    {
        ...
        /// somewhere else than the rest of the Hub is a log that cannot be
        ...
        /// <summary>Something is not as it should be, but the Hub carries on.</summary>
