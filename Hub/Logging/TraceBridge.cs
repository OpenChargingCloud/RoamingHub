...
namespace cloud.charging.open.RoamingHub.Logging
{
    ...
    /// <summary>
    /// Everything the libraries below this Hub write with Illias' DebugX,
    ...
    /// release build shows on the Logs page is what this Hub logs itself.
    ///
    ...
    /// away. What a Hub overhears is mostly OCPI going past it in both
    ...
    public sealed class TraceBridge : TraceListener
    {
        ...
        /// tell what the Hub said itself from what it overheard.
        /// </summary>
