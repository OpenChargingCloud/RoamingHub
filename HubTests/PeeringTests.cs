...
namespace cloud.charging.open.RoamingHub.Tests
{
    ...
    /// </remarks>
    public class PeeringTests : AHubTests
    {
        ...
        public async Task APeerRegistersWithThisHubOfItsOwnAccord()
        {
            ...
            Assert.Multiple(() => {
                ...
                Assert.That(ours?.Value<String>("url"),                           Is.EqualTo(Hub.OCPIVersionsURL.ToString()));
        ...
        public async Task ThisHubRegistersWithAPeerOfItsOwnAccord(String Role, String PartyId)
        {
            ...
            Assert.Multiple(() => {
                ...
                Assert.That(peer.ReceivedCredentials?.Value<String>("url"),                        Is.EqualTo(Hub.OCPIVersionsURL.ToString()));
        ...
        public async Task ThePeersAreKeptBetweenStarts()
        {
            ...
            var again = TestHubs.New(Directory, Configuration, Clock);
