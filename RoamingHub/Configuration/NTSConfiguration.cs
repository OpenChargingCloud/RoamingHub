...
namespace cloud.charging.open.RoamingHub.Configuration
{
    ...
    /// <summary>
    /// The "nts" section of the configuration file: where this RoamingHub
    ...
    /// missing keeps whatever the RoamingHub was given at construction.
    /// </remarks>
    /// <param name="Enabled">Whether this RoamingHub asks a time server at all.</param>
    ...
    /// <param name="CheckEvery">How often this RoamingHub checks its clock against that server.</param>
                                          ...
                                          TimeSpan?                             MaxDeviation          = null)
    {
        ...
        /// <summary>
        /// How often this RoamingHub checks its clock against its time server,
        ...
        /// public time server does not notice this RoamingHub at all.
        /// </remarks>
        public static readonly TimeSpan  DefaultCheckEvery        = TimeSpan.FromMinutes(15);

        /// <summary>
        /// How far this RoamingHub's clock may be from the time it was checked
        ...
        /// <summary>
        /// The time server this RoamingHub asks when nothing says otherwise.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// The section as it is written to the file; what this RoamingHub was not
