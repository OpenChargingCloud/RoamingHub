...
namespace cloud.charging.open.RoamingHub.Configuration
{
    ...
    /// <summary>
    /// The configuration of this RoamingHub, in a file beside it.
    /// </summary>
    /// <remarks>
    /// What a RoamingHub is - what it is called in OCPI, where it
    ...
    /// </remarks>
    public sealed class RoamingHubConfigFile
    {
        ...
        /// </summary>
        public RoamingHubConfigFile(String Path)
        {
        ...
        /// </summary>
        public Boolean TryLoad([NotNullWhen(true)] out RoamingHubConfiguration?  Configuration,
                                                   out String?                Error)
        {
            ...
            if (!RoamingHubConfiguration.TryParse(document, out Configuration, out var problem))
            {
                Error = $"'{Path}': {problem}";
                return false;
            }
        ...
        /// </summary>
        /// <remarks>
        /// This is what makes a partial save safe: a RoamingHub that only
                                       ...
                                       [NotNullWhen(false)] out String?   Error)
        {
            ...
            if (!File.Exists(Path))
            {
                // No file is not a failure, it is a RoamingHub nobody has
        ...
        /// rather than half of the new one. A RoamingHub that cannot read
                                ...
                                [NotNullWhen(false)] out String?  Error)
        {
            ...
            try
            {
                ...
                // Move, not copy: on every file system this RoamingHub runs on
