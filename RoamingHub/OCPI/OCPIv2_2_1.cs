...
namespace cloud.charging.open.RoamingHub.OCPI
{
    ...
    /// <summary>
    /// OCPI 2.2.1, as this hub speaks it.
    /// </summary>
    /// <remarks>
    /// The version the hub role arrived in, and the one both ends of a
    /// peering have been run against. A party is named by a country code and
    /// a party identification together, several of them can sit behind one
    /// endpoint, and the access tokens travel base64 encoded.
    /// </remarks>
    public sealed class OCPIv2_2_1 : OCPIVersion
    {
        ...
        public OCPIv2_2_1(RoamingHub            RoamingHub,
            ...
            commonAPI = new V.CommonAPI(
                            ...
                            OurPartyData:              [
                                                           new V.PartyData(
                                                               RoamingHub.PartyId,
                                                               Role.HUB,
                                                               RoamingHub.BusinessDetails,
                                                               RoamingHub.OCPI.AllowDowngrades
                                                           )
                                                       ],
                            DefaultPartyId:            RoamingHub.PartyId,
                            ...
                            HTTPServerName:            $"OpenChargingCloud RoamingHub v{RoamingHub.Version}",
                            HTTPServiceName:           $"OpenChargingCloud RoamingHub v{RoamingHub.Version}",
