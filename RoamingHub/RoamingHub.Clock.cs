...
namespace cloud.charging.open.RoamingHub
{
    ...
    /// <summary>
    /// What time this RoamingHub thinks it is, and what that is worth.
    /// </summary>
    /// <remarks>
    /// Two different questions, and a RoamingHub has to keep them apart.
    ...
    /// **this RoamingHub does not set its clock from the answer**. It measures the
    /// difference and reports it.
    ///
    /// That is deliberate. A RoamingHub stamps everything its roaming partners send
    ...
    /// <c>nts.legalTimeAuthority</c>, and this RoamingHub then only repeats that
    ...
    /// RoamingHub that has not checked, and the whole point of not
    ...
    public partial class RoamingHub
    {
        ...
        /// <summary>
        /// How often this RoamingHub checks its clock.
        /// </summary>
        ...
        /// <summary>
        /// How far this RoamingHub's clock may be off and still count.
        /// </summary>
        ...
        /// <summary>
        /// Begin checking this RoamingHub's clock against its time server.
        /// </summary>
        /// <remarks>
        /// Through the RoamingHub's own <see cref="TimeProvider"/> rather than a
        ...
        private void StartCheckingTheClock()
        {
            ...
            if (!NTSEnabled)
            {
                Log.Info("The clock of this RoamingHub is not being checked: NTS is switched off.", "nts", "clock");
                return;
            }
        ...
        private async Task CheckTheClockAsync()
        {
            ...
            try
            {
                ...
                if (result.Value<Boolean>("ok") != true)
                    Log.Warning(
                        $"The clock of this RoamingHub could not be checked: {result.Value<String>("error") ?? "no answer"}.",
                        "nts", "clock"
                    );
            ...
            {
                Log.Warning($"The clock of this RoamingHub could not be checked: {e.Message}", "nts", "clock");
            }
        ...
        public JObject ClockJSON()
        {
            ...
            return new JObject(
                       ...
                       // Said out loud: the number above is this RoamingHub's own
