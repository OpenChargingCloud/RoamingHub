...
namespace cloud.charging.open.RoamingHub.Web
{
    ...
    /// <summary>
    /// What somebody signed in to this RoamingHub is allowed to do.
    /// </summary>
    /// <remarks>
    ...
    public enum Permissions : UInt32
    {
        ...
        /// <summary>
        /// Change how this RoamingHub reaches the network: its name resolution and
        /// where it reads the time.
        /// </summary>
        /// <remarks>
        /// Reversible, and it complains: a wrong name server makes the RoamingHub say
        /// so, and the next change puts it right. That is what separates it
        /// from the settings describing who is around this RoamingHub - the roaming
        ...
        /// <summary>
        /// Make this RoamingHub ask a name server or a time server something, to
        /// find out whether it can.
        /// </summary>
        /// <remarks>
        /// Its own permission and not part of reading: a diagnostic sends
        /// traffic from this RoamingHub to a host somebody named, which is more than
    ...
    /// </summary>
    /// <remarks>
    /// A closed set: a role this RoamingHub has never heard of is a role it cannot
                                  ...
                                  Permissions  Permissions)
    {
        ...
        /// <summary>
        /// May look at this RoamingHub, and do nothing to it.
        /// </summary>
        ...
        /// <summary>
        /// Everything this RoamingHub can be told, by whoever is trusted with all of
        /// it at once.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Every role this RoamingHub knows.
        /// </summary>
                                       ...
                                       [NotNullWhen(false)] out String?    Error)
        {
            ...
            Error  = Role is null
                         ? $"\"{Text}\" is not a role this RoamingHub knows. Known roles: {String.Join(", ", All.Select(role => role.Name))}."
                         : null;
    ...
    public static class UserRoleExtensions
    {
        ...
        /// </summary>
        /// <remarks>
        /// What the browser is told is a copy of what the RoamingHub enforces, and
